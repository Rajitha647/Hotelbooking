                    ...
                    <div className="flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500">
                        ...
                        <div className="w-px h-15 bg-gray-300/70 max-md:hidden"></div>
                            ...
                            <div className="flex flex-col">
                                ...
                                <input type="number" id="guests" placeholder="check-In" className="max-w-20 rounded border border-gray-300 py2 px-3 mt-1.5 outline-none" required />
                            </div>
                       ...
                       Check Availability
                        ...
                        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
                            <p>Guests will be allocated on the ground floor according to availability.
                                You get a comfortable Two bedroom apartment has a true city feeling. The price quoted is for two guest, at the guest slot please mark the number of guests to get the exact price for groups.
                            </p>
                        </div>
                        {/* hosted by */}
