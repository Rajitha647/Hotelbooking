...
function AllRooms(){
    ...
    const roomTypes =[
        "single Bed","Double Bed","Luxuary Room","Family Suite",
    ];
                ...
                {roomsDummyData.map((room)=>(
                    <div key={room._id} className="flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0">
                        <img  onClick={()=>{navigate(`/rooms/${room._id}`);scrollTo(0,0)}}
                         src={room.images[0]} tittle="View Room Details" alt="hotel-img" className="max-h-65 md:w-1/2 rounded-xl shadow-lg object-cover cursor-pointer" />
